...
function addRatingAverage() {
    ...
    let ratingUsersAverageNumber = ratingUsersAverage.innerText;
    if (ratingUsersAverageNumber === "SIN VALORACIONES") {
        ratingUsersAverage.parentNode.style.display = "none"
    } else {
        ...
        if(ratingPasarANumero === 1) {
            ...
            ratingImageAverage.src = `https://darkblobcine.com/images/rating/4.5_stars_green.svg`;
